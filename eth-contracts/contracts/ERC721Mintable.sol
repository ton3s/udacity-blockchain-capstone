...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused() {
        require(_paused == false, "Function is paused");
        _;
    }

    modifier paused() {
        require(_paused == true, "Function is not paused");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != tokenOwner, "You are the owner of the token");

        // TODO require the msg sender to be the owner of the token or isApprovedForAll() to be true
        require(msg.sender == tokenOwner || isApprovedForAll(tokenOwner, msg.sender) == true);
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "The address of the token owner is invalid");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        address tokenOwner = ownerOf(tokenId);
        require(from == tokenOwner, "Only the token own can transfer ownership of the token");

        // TODO: require token is being transfered to valid address
        require(to != address(0), "The address being transferred to is invalid");
...
contract CustomERC721Token is ERC721Metadata {
    ...
    constructor() ERC721Metadata("Tones NFT", "TONES", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") public { 
    }
